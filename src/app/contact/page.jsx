...
function Contact() {
  ...
  return (
    <>
      <ServiceHeader />
      <div className="w-full lg:max-w-[1500px] m-auto overflow-hidden py-6 px-8 bg-white rounded-xl max-md:px-4 max-md:py-4">
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            <div className="flex flex-col w-full lg:w-1/2">
              <div className="flex flex-col bg-slate-100 rounded-xl p-4">
                ...
                <p className="text-lg text-black mb-8">
                  Say something to start and lets chat!
                </p>
                ...
                <div className="flex items-center gap-5 mt-4 text-base text-black flex-wrap">
                  ...
                  />
                  <span>
                    7603 Finns lane Lanham MD 20706-1219 United States
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col w-full lg:w-1/2">
              <div className="flex flex-col font-medium mt-8 md:mt-0">
                ...
                <button
                  type="submit"
                  className="justify-center self-end px-8 py-4 mt-6 text-base text-center text-white bg-amber-400 rounded-xl shadow-sm cursor-pointer"
                >
                  Send Message
                </button>
              </div>
