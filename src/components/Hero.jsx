...
function Hero() {
  return (
    <section className="self-stretch pl-20 w-full bg-slate-100 max-md:pl-5 max-md:max-w-full">
      <header className="flex gap-5 max-md:flex-col max-md:gap-0 max-md:">
        <nav className="flex flex-col w-[41%] max-md:ml-0 max-md:w-full">
          <div className="flex flex-col mt-11 max-md:mt-10 max-md:max-w-full">
            <div className="flex gap-3.5 self-start mt-52 text-base font-semibold tracking-wider leading-7 text-sky-600 whitespace-nowrap max-md:mt-10">
              <img
                loading="lazy"
              ...
              />
              <div className="grow my-auto">ESTABLISHED SINCE 2000</div>
            </div>
            <div className="mt-8 text-6xl font-semibold tracking-tighter leading-[65px] text-neutral-900 max-md:max-w-full max-md:text-4xl max-md:leading-[52px]">
              <p>A New Solutions For Your Home Cleaning</p>
            </div>
            <div className="mt-9 text-base tracking-wide leading-7 text-zinc-800 max-md:max-w-full">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore.
            </div>
            <div className="flex gap-5 justify-between items-center mt-9 text-base max-md:flex-wrap max-md:max-w-full">
